    ...
    return (
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <div class="container px-4 px-lg-5">
                <a class="navbar-brand" href="/">E-commerce SD</a>
                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                ...
                                <li><a class="dropdown-item" href="/categoria/Nike">Nike</a></li>
                                <li><a class="dropdown-item" href="/categoria/Adidas">Adidas</a></li>
                            </ul>
                        </li>
                        ...
                        {% else %}
                        <li class="nav-item"><a class="nav-link" href="{% url 'enter' %}">Login</a></li>
