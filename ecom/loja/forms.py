...
class SignUpForm(UserCreationForm):
	...
	def __init__(self, *args, **kwargs):
		...
		self.fields['username'].help_text = '<span class="form-text text-muted"><small>Necessário. 150 ccaracteres or menos. Somente letras, digitos e @/./+/-/_ .</small></span>'

		self.fields['password1'].widget.attrs['class'] = 'form-control'
		self.fields['password1'].widget.attrs['placeholder'] = 'Password'
		self.fields['password1'].label = ''
		self.fields['password1'].help_text = '<ul class="form-text text-muted small"><li> Sua senha não pode ser muito similar a suas outras informações pessoais.</li><li> Sua senha deve conter ao menos 8 caracteres.</li><li>Sua senha não poder ser uma sanha comum demais.</li><li>Sua senha não pode ser inteiramente numérica.</li></ul>'
